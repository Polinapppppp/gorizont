            ...
            <form action="{{ route('apartments.update', $apartment->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div style="display: flex; gap: 15px;">
                    <div class="auth-field" style="flex: 1;">
                        <label for="area" style="display:block; margin-bottom: 8px; font-weight: 500;">Общая площадь
                            (м²)</label>
                ...
                <div style="display: flex; gap: 15px;">
                    <div class="auth-field" style="flex: 1;">
                        ...
                        <input type="number" name="rooms" id="rooms"
                            value="{{ old('rooms', $apartment->rooms) }}" placeholder="2" required
                            style="width: 100%; padding: 12px 16px; border: 1px solid rgba(0,0,0,0.1); border-radius: 12px; font-size: 16px; font-family: 'Montserrat', sans-serif;">
                ...
                <div class="auth-field">
                    ...
                    <input type="number" name="price" id="price"
                        value="{{ old('price', $apartment->price) }}" placeholder="15000000"
                        style="width: 100%; padding: 12px 16px; border: 1px solid rgba(0,0,0,0.1); border-radius: 12px; font-size: 16px; font-family: 'Montserrat', sans-serif;">
                ...
                @if ($apartment->image)
                    <div class="auth-field">
                        <label style="display:block; margin-bottom: 8px; font-weight: 500;">Текущее фото</label>
                        <div class="current-photo">
                            <img src="{{ asset('storage/' . $apartment->image) }}" alt="Текущее фото">
                        </div>
                        <p style="font-size: 12px; color: grey; margin-bottom: 10px;">Загрузите новое, чтобы заменить
                        </p>
                    </div>
                @endif
                ...
                <div class="auth-field">
                    ...
                    <textarea name="description" id="description" rows="3" placeholder="Дополнительная информация..."
                        style="width: 100%; padding: 12px 16px; border: 1px solid rgba(0,0,0,0.1); border-radius: 12px; outline: none; font-size: 16px; font-family: 'Montserrat', sans-serif; resize: vertical;">{{ old('description', $apartment->description) }}</textarea>
                </div>

                <button type="submit" class="auth-submit" style="margin-top: 20px;">Сохранить изменения</button>
